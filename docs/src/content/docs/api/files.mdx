...
<PropsTable
  props={[
    { name: 'id', type: 'number', description: 'Unique file identifier.' },
    { name: 'filename', type: 'string', description: 'Original name of the uploaded file.' },
    { name: 'path', type: 'string', description: 'Server filesystem path to the stored file.' },
    { name: 'user_id', type: 'number', description: 'ID of the user who uploaded the file.' },
    { name: 'created_at', type: 'string', description: 'Timestamp when the file was uploaded (ISO 8601).' },
  ]}
/>
