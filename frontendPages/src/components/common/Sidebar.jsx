				...
				<ul className='flex flex-col gap-3 mt-4'>
					<li className='flex justify-center md:justify-start'>
						...
						>
							...
							<span className='text-lg hidden md:block'>Create Courses</span>
						</Link>
					</li>
					<li className='flex justify-center md:justify-start'>
						<Link
						...
						>
							...
							<span className='text-lg hidden md:block'>Select Courses</span>
						</Link>
					</li>
					...
					<li className='flex justify-center md:justify-start'>
						...
						>
							...
							<span className='text-lg hidden md:block'>Approve Courses</span>
						</Link>
					</li>
				</ul>
				{data && (
					...
					>
						...
						<div className='flex justify-between flex-1'>
							<div className='hidden md:block'>
								<p className='text-grey-300 font-bold text-sm w-20 truncate'>{data?.fullName}</p>
